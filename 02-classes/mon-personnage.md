# Mon Personnage - Paladin Niveau 3
...
| Stat | Score | Mod | Explication |
|------|-------|-----|-------------|
| **FOR** | 16 | +3 | Ta force de frappe |
| **DEX** | 10 | +0 | Moyenne, t'es pas agile mais pas maladroit |
| **CON** | 14 | +2 | Solide, tu encaisses |
| **INT** | 12 | +1 | Au-dessus de la moyenne (ton intellect 89%) |
| **SAG** | 10 | +0 | Correct, tu te fies plus à la logique qu'à l'intuition |
| **CHA** | 14 | +2 | Présence naturelle, assertif sans être flamboyant |
...
| **Points de Vie** | 28 | 10 + 2×(1d10+2) ou fixe: 10+7+7+4 |
| **Vitesse** | 30 ft | Standard humain |
| **Initiative** | +0 | DEX mod |
| **Bonus de Maîtrise** | +2 | Niveau 1-4 |

### Attaques

| Arme | Toucher | Dégâts | Notes |
|------|---------|--------|-------|
| Épée longue | +5 | 1d8+3 tranchant | Versatile (1d10 à 2 mains) |
| Javeline | +5 | 1d6+3 perforant | Lancer 30/120 ft |

---

## Don (Humain Variant): Sentinel

**Pourquoi ce don?** Tu protèges les tiens. Personne ne passe.

### Effets:
- Quand tu **touches** une créature, sa **vitesse tombe à 0** pour le reste du tour
- Tu peux faire une **attaque d'opportunité** même si l'ennemi utilise **Disengage**
- Quand une créature à 5 ft de toi attaque quelqu'un **d'autre que toi**, tu peux utiliser ta **Réaction** pour l'attaquer

> **En jeu**: Tu es le mur. Les ennemis ne passent pas, et s'ils essaient de frapper tes alliés, ils mangent ton épée.

---

## Serment de Dévotion (Niveau 3)

### Les Préceptes
1. **Honnêteté** - Ne mens pas, ne triche pas
2. **Courage** - N'aie jamais peur d'agir
3. **Compassion** - Protège les faibles (à ta façon pragmatique)
4. **Honneur** - Traite les autres équitablement
5. **Devoir** - Sois responsable de tes actions
...
- **Action**: Touche pour soigner (autant que tu veux du pool)
- **Alternative**: 5 points pour guérir 1 maladie ou poison
- **Recharge**: Long repos

### Style de Combat: Defense (Niveau 2)
- **+1 CA** tant que tu portes une armure
- Ta vraie CA = **19** (18 + 1)

### Spellcasting (Niveau 2)
- **Emplacements**: 3 sorts de niveau 1
- **Sorts préparés**: 3 (CHA mod + demi-niveau = 2 + 1)
- **DD de sauvegarde**: 12 (8 + 2 + 2)
- **Modificateur d'attaque de sort**: +4 (2 + 2)

### Divine Smite (Niveau 2)
- **Quand**: Après avoir touché avec une attaque de mêlée
- **Coût**: 1 emplacement de sort
- **Dégâts**: +2d8 radiant (slot niveau 1)
- **Bonus**: +1d8 contre morts-vivants ou fiélons

> **Ta signature**: La colère froide. Quand quelqu'un menace les tiens, tu frappes et tu Smite. Pas de cri, pas de discours. Juste des dégâts.

---

## Sorts

### Sorts Préparés (choisis 3)
*Tu peux changer après chaque long repos*

| Sort | Action | Concentration | Effet |
|------|--------|---------------|-------|
| **Bless** | Action | Oui | 3 créatures: +1d4 attaques et saves pendant 1 min |
| **Shield of Faith** | Bonus | Oui | +2 CA à une cible pendant 10 min |
| **Cure Wounds** | Action | Non | Soigne 1d8+2 HP |

### Sorts de Serment (toujours prêts)
- **Protection from Evil and Good** - Avantage contre être charmé/effrayé/possédé par ces créatures
- **Sanctuary** - Les ennemis doivent réussir un save SAG pour t'attaquer
...
- **Compétences** (2): Athlétisme, Perspicacité

### Maîtrises de Background (Soldat)
- **Compétences**: Athlétisme (déjà), Intimidation
...
| Compétence | Stat | Bonus | Maîtrisé? |
|------------|------|-------|-----------|
| Athlétisme | FOR | +5 | ✅ |
| Intimidation | CHA | +4 | ✅ |
| Perspicacité | SAG | +2 | ✅ |
...
- *"Je parle peu. Quand je parle, c'est que ça compte."*
- *"Je planifie toujours avant d'agir. L'improvisation, c'est pour ceux qui n'ont pas préparé."*
...
### En combat
1. **Positionne-toi entre les ennemis et tes alliés** (Sentinel fait le reste)
2. **Round 1**: Bless si le combat s'annonce long, sinon attaque
3. **Garde tes Smites** pour les crits ou les moments clutch
4. **Sentinel**: Chaque fois qu'un ennemi essaie de passer ou de frapper un allié, BOUM

### En roleplay
- **Tu ne fais pas de longs discours**. Phrases courtes, directes.
- **Tu observes avant de juger**. (Intellect élevé = tu analyses)
- **Tu respectes la compétence**, pas les titres.
- **Tu protèges d'abord, tu poses des questions après.**

### Ta colère froide (ton défaut)
Quand quelqu'un menace sérieusement tes compagnons ou trahit ta confiance:
- Tu ne cries pas
- Ton visage se ferme
...
### Niveau 4
**Choix**: +2 FOR (→18, +4 mod) ou un Don

Dons intéressants:
- **Shield Master**: Bonus action pour pousser avec le bouclier, protection contre les Dex saves
- **Resilient (CON)**: Meilleur pour maintenir concentration sur Bless

### Niveau 5
- **Extra Attack**: 2 attaques par Action
- **Sorts niveau 2**: Aid, Find Steed

### Niveau 6
- **Aura of Protection**: +CHA mod (+2) à TOUS les saves pour toi et alliés à 10 ft
- C'est là que tu deviens vraiment le pilier du groupe
...
```
CA: 19 | HP: 28 | Vitesse: 30 ft

ATTAQUE: d20+5 → 1d8+3 tranchant

SMITE: Après touché, dépense slot → +2d8 radiant (+3d8 vs undead)

LAY ON HANDS: 15 HP pool, soigne au toucher

SENTINEL:
- Touché = ennemi vitesse 0
- Réaction si allié attaqué à côté de moi

SORTS (3 slots niveau 1):
- Bless: 3 cibles +1d4 attaque/saves [C]
- Shield of Faith: +2 CA [C]
- Cure Wounds: 1d8+2 HP

CHANNEL DIVINITY (1/repos):
- Sacred Weapon: +2 attaque, arme magique, lumière
```
...
**Lay on Hands restant**: _____ / 15

**Slots utilisés**: ☐ ☐ ☐

**Channel Divinity utilisé**: ☐

**Divine Sense restant**: _____ / 3
